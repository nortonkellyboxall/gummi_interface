...
class CollisionPrepare():
    ...
    def __init__(self):
        ...
        self.sub = rospy.Subscriber("/camera/urdf_filtered_dilated", Image, self.callback)
        # self.sub = rospy.Subscriber("/camera/depth/image_meters", Image, self.callback)
        ...
        self.box = 0.25 #the half width of the observation bounding box
